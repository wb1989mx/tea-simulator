...
- **采摘评分·按茶类区分**：绿茶/红茶/黄茶/白茶/黑茶按「嫩度越高品质潜质越高」单调评分（单芽最高、粗老最低），选嫩芽即高分，后续工艺参数自动按嫩度偏差调整；乌龙茶按「成熟度适当最优」倒U曲线评分（开面采最佳，带嫩芽过多或过于粗老都降分）；再加工茶按茶坯要求评分。选中名优茶档时，评分与工艺参数联动以该名优茶的采摘标准为基准（如东方美人需嫩采一芽一叶，铁观音需开面采）。
